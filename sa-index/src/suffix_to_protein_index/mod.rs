...
//!   GB over the ~300 M-residue reference text, and ~256 GB at the scale of the full UniProt
//!   index, where it would be larger than the 149 GB suffix array and larger than everything else
